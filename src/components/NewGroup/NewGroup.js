...
export class NewGroup extends React.Component {
  ...
  render() {
    ...
    return (
     ...
     // <div className="box"> 
     // 	<form>
     // 		<input type='text' className="boxbox" placeholder="Group Name"/>
     // 		<input type='text' className="boxbox" placeholder="Enter Name"/>
     // 		<input type='button' className="boxbox" value="Remove"/>
     // 	</form>
     // </div>
